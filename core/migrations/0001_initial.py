# Generated by Django 4.2.4 on 2024-03-19 17:16
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('prize', models.CharField(blank=True, choices=[('first', 'First Prize'), ('second', 'Second Prize'), ('third', 'Third Prize')], max_length=10, null=True)),
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('updated_at', models.DateTimeField(auto_now=True)),
                ('event', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='registrations', to='core.event')),
                ('group_members', models.ManyToManyField(blank=True, related_name='group_registrations', to=settings.AUTH_USER_MODEL)),
