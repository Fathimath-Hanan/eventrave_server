...
from core.views import CertificateDetailAPIView, CertificateListAPIView, EventDetailAPIView, EventListAPIView, JudgeDetailAPIView, JudgeListAPIView, ParticipantDetailAPIView, ParticipantListAPIView, ScoreDetailAPIView, ScoreListAPIView, StudentHomeAPIView
